...
# u"САО", u"СВАО",
uniq_okrugs = [u"САО", u"СВАО", u"ВАО", u"ЦАО", u"ЮВАО", u"ЮАО", u"ЮЗАО", u"ЗАО", u"СЗАО"]
...
districts = ({
	u"САО": [u"Восточное Дегунино", u"Дмитровский", u"Бескудниковский",
			 u"Тимирязевский", u"Аэропорт", u"Савеловский", u"Беговой",
			 u"Хорошевский", u"Сокол", u"Войковский", u"Коптево",
			 u"Головинский", u"Ховрино", u"Левобережный", u"Западное Дегунино",
			 u"Молжаниновский"],

	u"СВАО":[u"Северное Медведково", u"Южное Медведково", u"Лосиноостровский",
			 u"Бабушкинский", u"Ярославский", u"Свиблово", u"Ростокино",
			 u"Алексеевский", u"Марьина роща", u"Останкинский", u"Бутырский",
			 u"Марфино", u"Отрадное", u"Алтуфьевский", u"Бибирево",
			 u"Лианозово", u"Северный"],
